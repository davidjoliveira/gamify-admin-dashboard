...
export type GVInputRootPropsOwnerState = {
	error?: boolean;
	success?: boolean;
	disabled?: boolean;
  form?:string;
...
type GVInputRootProps = {
	ownerState: GVInputRootPropsOwnerState;
  form?:string;
} & TextFieldProps;

export default styled(TextField)<GVInputRootProps>(({ theme, ownerState }) => {
