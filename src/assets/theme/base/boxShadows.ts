...
export const ALL_BOX_SHADOWS_KEYS = [ "xs", "sm", "md", "lg", "xl", "xxl", "inset", "colored", "navbarBoxShadow", "sliderBoxShadow", "tabsBoxShadow" ]
export type BoxShadowsKeys = "xs" | "sm" | "md" | "lg" | "xl" | "xxl" | "inset" | "colored" | "navbarBoxShadow" | "sliderBoxShadow" | "tabsBoxShadow";
...
export type BoxShadowsType = {
  ...
  sliderBoxShadow: ColoredType;
  tabsBoxShadow: ColoredType;
}
